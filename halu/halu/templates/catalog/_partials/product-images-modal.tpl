      ...
      <div class="modal-body">
        ...
        <figure>
          {if $product.default_image}
            <picture>
              ...
              id="changemodal"
                ...
                src="{$product.default_image.bySize.large_default.sources.jpg}"
          ...
          {block name='product_description_short'}
            <div id="product-description-short">{*{$product.description_short nofilter}*}Imaginile sunt cu caracter informational!</div>
          {/block}
        </figcaption>
        </figure>
      </div>
