				...
				{foreach from=$languages item=language}
					...
					{/if}
						<div class="col-lg-{if $languages|count > 1}10{else}12{/if}">
							...
							<video class="video-block slide" playsinline="" muted="" loop="" autoplay="" preload="metadata" width="100%" height="100%" data-src="{$image_baseurl}{$fields[0]['form']['images'][$language.id_lang]}" type="video/mp4" src="{$image_baseurl}{$fields[0]['form']['images'][$language.id_lang]}"></video>
							{/if}
