 ...
 *}
<div class="product-line-grid modhalucos-line-grid">
  <!--  product line left content: image-->
  <div class="product-line-grid-left col-md-3 col-xs-3 modhalucos-grid-left">
  ...
  <div class="product-line-grid-body modhalucos-grid-body col-md-6 col-xs-6">
    <div class="product-line-info modhalucos-line-info">
  ...
  <div class="product-line-grid-right modhalucos-grid-right product-line-actions col-md-3 col-xs-3">
    <div class="row">
      ...
      <div class="col-md-2 col-xs-2 text-xs-left">
